...
class DrawViewModel : ViewModel() {
    lateinit var offScreenBitmap: Bitmap; private set
    private lateinit var offScreenCanvas: Canvas
    lateinit var touchPointsBitmap: Bitmap; private set
    ...
    fun beginTouch(x: Float, y: Float, t: Long) {
        ...
        lastStroke = Stroke().also {
            smoother.beginTouch(it, x, y, t)
        }
    }
